    ...
    var bbTrivia = {
            ...
            play: function (current) {                                                                // play function with current question as an argument
                ...
                $('.a-option').on('click', function () {                                              // when one of answer options is clicked
                    ...
                    if (guess === current.correct) {                                                  // if the players guess matches the correct answer for the current question
                        ...
                        ($(this).switchClass('btn-hover', 'btn-correct', 750));                       //   change buttons class to "correct" which shows green
                        ...
                        ($(this).switchClass('btn-hover', 'btn-wrong', 750));                         //   then add X at the beginning of the answer selected
                        $('.a-option').attr('disabled', 'true');                                      //   disable all buttons from further click until next question is presented
                    }
            ...
            qDisplay: function (current) {                                        // question display function taking a question object as an argument,
                ...
                this.seconds = 15;                                                // set timer to 15 seconds
            ...
            decrement: function () {                                      // function that decrements timer
                ...
                $("#timer").html(bbTrivia.seconds);                  // display current number of seconds to screen
                $('#timer').fadeIn(100);
                if (bbTrivia.seconds === 0) {                             // if number of seconds has expired
